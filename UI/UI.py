...
class Ui_mainWindow(object):
    def __init__(self):
        ...
        self.button_add = QtGui.QPushButton('Add Times')
        self.start_display = QtGui.QTextEdit()
        self.end_display = QtGui.QTextEdit()
        self.hours_display = QtGui.QTextEdit()
    ...
    def setup_ui(self, parent_window):
        ...
        self.start_display.setMaximumHeight(30)
        self.end_display.setMaximumHeight(30)
        self.hours_display.setMaximumHeight(30)
        self.from_display.setMaximumHeight(30)
        self.time_display.setMaximumHeight(30)
        self.to_display.setMaximumHeight(30)
        horiz_header = self.time_table.horizontalHeader()
        horiz_header.setResizeMode(QtGui.QHeaderView.Stretch)

        # Labels
        label_start = QtGui.QLabel('Start')
        label_start.setAlignment(QtCore.Qt.AlignCenter)
        label_start.setMaximumHeight(10)
        label_end = QtGui.QLabel('End')
        label_end.setAlignment(QtCore.Qt.AlignCenter)
        label_end.setMaximumHeight(10)
        label_hours = QtGui.QLabel('Hours')
        label_hours.setAlignment(QtCore.Qt.AlignCenter)
        label_hours.setMaximumHeight(10)
        ...
        start_fin_layout.addWidget(self.button_add, 0, 1, align)
        start_fin_layout.setRowMinimumHeight(1, 5)
        start_fin_layout.addWidget(label_start, 2, 0, align)
        start_fin_layout.addWidget(label_end, 2, 1, align)
        start_fin_layout.addWidget(label_hours, 2, 2, align)
        start_fin_layout.addWidget(self.start_display, 3, 0, align)
        start_fin_layout.addWidget(self.end_display, 3, 1, align)
        start_fin_layout.addWidget(self.hours_display, 3, 2, align)
        start_fin_layout.setRowMinimumHeight(4, 5)
        start_fin_layout.addWidget(label_from, 5, 0, align)
        start_fin_layout.addWidget(label_time, 5, 1, align)
        start_fin_layout.addWidget(label_to, 5, 2, align)
        start_fin_layout.addWidget(self.from_display, 6, 0, align)
        start_fin_layout.addWidget(self.time_display, 6, 1, align)
        start_fin_layout.addWidget(self.to_display, 6, 2, align)


        # Job control group
        job_ctrl_box = QtGui.QWidget()
        job_ctrl_layout = QtGui.QVBoxLayout()
        job_ctrl_box.setLayout(job_ctrl_layout)
        job_ctrl_layout.addWidget(self.button_test)
        ###################################################
        # Map group
