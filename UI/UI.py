...
class Ui_mainWindow(object):
    def __init__(self):
        ...
        # Timer
        self.button_sel_ticket = QtGui.QPushButton("Ticket")
        self.menu_curr_tickets = QtGui.QMenu()
        ...
        self.time_running = QtGui.QLineEdit()
        self.time_total = QtGui.QLineEdit()
    ...
    def setup_ui(self, parent_window):
        ...
        self.menu_curr_tickets.setStyleSheet(DarkStyle.load_stylesheet())
        ...
        ticket_container = QtGui.QGroupBox()
        ticket_timer_layout = QtGui.QHBoxLayout()
        ticket_list_layout = QtGui.QGridLayout()
